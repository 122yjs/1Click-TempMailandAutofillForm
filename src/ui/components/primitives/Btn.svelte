<!--
  ...
  Variants:
    ...
    primaryOutline — bordered primary accent (export/import style)
    tonal          — soft primary tint (primary/10 fill, primary text)
...
const variantMap: Record<NonNullable<Props['variant']>, string> = {
  ...
  primaryOutline: 'border border-md-primary text-md-primary hover:bg-md-primary/10',
  tonal: 'bg-md-primary/10 text-md-primary hover:bg-md-primary/20',
};
